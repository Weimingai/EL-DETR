...
"""
# ------------------------------------------------------------------------
# Modify from DETR (https://github.com/facebookresearch/detr)
...
class Transformer(nn.Module):
    ...
    def forward(self, src, mask, query_embed, pos_embed, self_attn_mask=None): # H-matching self_attn_mask
        ...
        hs, references = self.decoder(tgt, memory, memory_key_padding_mask=mask,
                          pos=pos_embed, query_pos=query_embed, tgt_mask=self_attn_mask) # H-matching tgt_mask=self_attn_mask
